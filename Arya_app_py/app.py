from flask import Flask, request, send_from_directory, render_template, redirect, url_for, flash, send_file # type: ignore
import os
import mimetypes

app = Flask(__name__)
app.secret_key = 'ishanihar'
NAS_DIR = 'C:/Users/aryas/Desktop/nasarya'  # Ensure this path exists and Flask has access to it.
